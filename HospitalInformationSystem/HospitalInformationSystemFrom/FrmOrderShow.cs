...
namespace HospitalInformationSystemFrom
{
    public partial class FrmOrderShow : Form
    {
        ...
        private async void getMedicalVisit(DateTime dateTime)
        {
            ...
            MedicalVisit tempMedicalVisit = MedicalVisits.FirstOrDefault(t => t.VisitDate.ToString("yyyy-MM-dd") == dateTime.ToString("yyyy-MM-dd") && t.PatientID == FrmLogin.OperatorID);

            if (tempMedicalVisit != null)
            {
                selectVisitID = tempMedicalVisit.VisitID;
            }
        ...
        private async void button2_Click(object sender, EventArgs e)
        {
            Prescription tempPrescription = new Prescription
            {
                ...
                DosagePerUse = comboBoxDosagePerUse.Text,

    ...
    public partial class FrmUserRegistration : Form
    {
        ...
        UserInfo setUserValues(UserInfo userInfo)
        {
            if (userInfo.IDNumber == null)
            {
                ...
                userInfo.RoleID = (comboBoxRole.SelectedIndex + 1).ToString();
            ...
            else
            {
                ...
                comboBoxRole.SelectedIndex = Convert.ToInt32(userInfo.RoleID) - 1;
        ...
        private async void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("请选择角色类型", "提示", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
